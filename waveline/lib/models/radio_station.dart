class RadioStation {
  ...
  static const List<RadioStation> seedStations = [
    RadioStation(
      ...
      imageUrl: 'https://picsum.photos/seed/city_fm/200/200',
      emoji: '🏙️',
      listeners: 1243,
    ...
    RadioStation(
      ...
      imageUrl: 'https://picsum.photos/seed/afrobeats/200/200',
      emoji: '🕺🏾',
      listeners: 2891,
    ...
    RadioStation(
      ...
      imageUrl: 'https://picsum.photos/seed/bbc_world/200/200',
      emoji: '🌍',
      listeners: 5621,
    ...
    RadioStation(
      ...
      imageUrl: 'https://picsum.photos/seed/gospel/200/200',
      emoji: '🙌🏾',
      listeners: 987,
    ...
    RadioStation(
      ...
      imageUrl: 'https://picsum.photos/seed/classic_rock/200/200',
      emoji: '🎸',
      listeners: 1765,
